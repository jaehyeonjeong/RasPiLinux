...
#define FILE_PATH "/home/user/.ssh/RasPiLinux/mmap_example/mmap_test"
...
/**
 *  @breif MMAP_TEST_STRUCT 구조체 셋팅 함수
 *
 *  @param in_name 이름
 *  @param in_age 나이
 *  @param in_hobby 취미
...
int main(int argc, char **argv)
{
	...
	yj_setting_struct("YOON YEONG JIN", 26, "Play Room Escape game", &in);
        yj_print_struct(in);
